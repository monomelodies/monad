...
export default class controller {
    ...
    constructor(_monadLanguageService_, _Authentication_, _$uibModal_, MONAD_VERSION, MONAD_COPYRIGHT) {
...
controller.$inject = ['monadLanguageService', 'Authentication', '$uibModal', 'MONAD_VERSION', 'MONAD_COPYRIGHT'];
