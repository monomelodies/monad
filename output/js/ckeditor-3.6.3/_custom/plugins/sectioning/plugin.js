...
CKEDITOR.plugins.add( 'basicstyles',
{
    ...
    init : function( editor )
    {
        ...
        addButtonCommand('Article', lang.article, 'article'        , config.coreStyles_article );
        addButtonCommand('Section', lang.section, 'section'      , config.coreStyles_section );
        addButtonCommand('Aside', lang.aside, 'aside'   , config.coreStyles_aside );
        addButtonCommand('Header', lang.header, 'header'      , config.coreStyles_header );
    }
});

CKEDITOR.config.coreStyles_article = {element: 'article'};
CKEDITOR.config.coreStyles_section = {element: 'section'};
CKEDITOR.config.coreStyles_aside = {element: 'aside'};
CKEDITOR.config.coreStyles_header = {element: 'header'};
// Basic Inline Styles.
