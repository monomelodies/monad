...
angular.module('pascalprecht.translate').factory('$translateDefaultInterpolation', ['$interpolate', function($interpolate) {
  var $translateInterpolator = {},
      ...
      sanitizeValueStrategies = {escaped: function(params) {
          var result = {};
...
System.import('assets/js/angular-translate');
System.import('assets/js/angular-ui-router');
angular.module('monad', ['ui.router', 'ngAnimate', 'ngSanitize', 'pascalprecht.translate']);
angular.module('monad').run(['$http', '$rootScope', function($rootScope, $http) {
...
angular.module('monad').config(['$stateProvider', '$translateProvider', function($stateProvider, $translateProvider) {
  $translateProvider.preferredLanguage('nl');
  $stateProvider.state('monad', {
    'abstract': true,
    views: {
      '': {template: '<ui-view/>'},
      sidebar: {
        templateUrl: '/assets/html/snippet/sidebar.html',
